package com.ishankdev.versionchecker;
...
/**
 * Created by ishank on 28/04/2017.
 */
public class CheckVersion extends AsyncTask<Void, Void, CheckVersion.Result> {
    ...
    public CheckVersion setOnTaskCompleteListener(ITaskComplete listener) {
